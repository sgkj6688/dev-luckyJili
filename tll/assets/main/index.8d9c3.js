System.register("chunks:///main.js", ["./index-b807b947.js", "cc"], function () {
    "use strict";
    var t,
        e,
        i,
    ...
    return {
        ...
        execute: function () {
            ...
            var Oe,
                ...
                ke = E.ccclass,
                Ie = E.executionOrder,
                Ae = E.requireComponent,
                Re = E.type,
                xe = E.executeInEditMode,
                Le = E.property,
                Pe = new O();
            (!(function (t) {
                ((t[(t.NONE = 0)] = "NONE"),
            ...
            var Be, Fe, Me, De, ze, Ge, He, Ve, We, Ue, je, Xe, Je, qe, Ye, Ke, Ze, Qe, $e, ti, ei, ii, ni, oi, ri, ai, si, li, ci;
            ((Rt = ke("ButtonPro")),
                (xt = Ie(110)),
                (Lt = Ae(N)),
                (Pt = Le({ type: k, displayOrder: 0, tooltip: "i18n:button.target" })),
                (Bt = Le({ displayOrder: 1, tooltip: "i18n:button.interactable" })),
                (Ft = Le({ type: Oe, displayOrder: 2, tooltip: "i18n:button.transition" })),
                ...
                (Wt = Le({ group: { name: "SPRITE" }, type: I, displayOrder: 3, tooltip: "i18n:button.normal_sprite" })),
                (Ut = Le({ group: { name: "SPRITE" }, type: I, displayOrder: 3, tooltip: "i18n:button.pressed_sprite" })),
                (jt = Le({ group: { name: "SPRITE" }, type: I, displayOrder: 3, tooltip: "i18n:button.hover_sprite" })),
                (Xt = Le({ group: { name: "SPRITE" }, type: I, displayOrder: 3, tooltip: "i18n:button.disabled_sprite" })),
                (Jt = Re([A])),
                                ...
                                Lt(
                                    (le =
                                        xe(
                                                ...
                                                return (
                                                    (a.onLoad = function () {
                                                        if (!this.getComponent(x)) {
                                                            var t = this.addComponent(x);
                                                            if (t) {
                                                                ((t.sizeMode = x.SizeMode.CUSTOM), (t.type = x.Type.SLICED));
                                                    ...
                                                    (a.__preload = function () {
                                                        ...
                                                        var t = this.node.getComponent(x);
                                                    ...
                                                    (a.update = function (t) {
                                                        var e = this.target;
                                                        if (!this._transitionFinished && e && (this._transition & Oe.COLOR || this._transition & Oe.SCALE)) {
                                                            this._time += t;
                                                            var i = 1;
                                                            if (
                                                                (this._duration > 0 && (i = this._time / this._duration),
                                                                i >= 1 && (i = 1),
                                                                this._transition & Oe.COLOR)
                                                            ) {
                                                                var n = e._uiProps.uiComp;
                                                                (O.lerp(Pe, this._fromColor, this._toColor, i), n && (n.color = Pe));
                                                            }
                                                            (this.transition & Oe.SCALE &&
                                                    ...
                                                    (a._resetState = function () {
                                                        ...
                                                        if (t) {
                                                            ...
                                                            if (e & Oe.COLOR && this._interactable) {
                                                                var i = t.getComponent(M);
                                                                i && (i.color = this._normalColor);
                                                            }
                                                            (e & Oe.SCALE && this._originalScale && t.setScale(this._originalScale),
                                                    ...
                                                    (a._onTargetSpriteFrameChanged = function (t) {
                                                        this._transition & Oe.SPRITE && this._setCurrentStateSpriteFrame(t.spriteFrame);
                                                    }),
                                                    ...
                                                    (a._onTargetColorChanged = function (t) {
                                                        this._transition & Oe.COLOR && this._setCurrentStateColor(t);
                                                    }),
                                                    ...
                                                    (a._onTouchMove = function (t) {
                                                        if (this._interactable && this.enabledInHierarchy && this._pressed && t) {
                                                            ...
                                                            if (e) {
                                                                ...
                                                                if (this._transition & Oe.SCALE && this.target && this._originalScale)
                                                                    n
                                                                ...
                                                                else ((i = n ? Te.PRESSED : Te.NORMAL), this._applyTransition(i));
                                                    ...
                                                    (a._onTouchEnded = function (t) {
                                                        this._interactable &&
                                                            this.enabledInHierarchy &&
                                                            (this._pressed && (A.emitEvents(this.clickEvents, t), this.node.emit(Ne.CLICK, this)),
                                                            (this._pressed = !1),
                                                            this._updateState(),
                                                            t && (t.propagationStopped = !0));
                                                    }),
                                                    ...
                                                    (a._onMouseMoveIn = function () {
                                                        !this._pressed &&
                                                            this.interactable &&
                                                            this.enabledInHierarchy &&
                                                            ((this._transition & Oe.SPRITE && !this._hoverSprite) ||
                                                                this._hovered ||
                                                    ...
                                                    (a._applyTransition = function (t) {
                                                        var e = this._transition;
                                                        (e & Oe.COLOR && this._updateColorTransition(t),
                                                            e & Oe.SPRITE && this._updateSpriteTransition(t),
                                                            e & Oe.SCALE && this._updateScaleTransition(t));
                                                    }),
                                                    ...
                                                    (a._xrUnClick = function () {
                                                        this._interactable &&
                                                            this.enabledInHierarchy &&
                                                            (this._pressed && (A.emitEvents(this.clickEvents, this), this.node.emit(Ne.CLICK, this)),
                                                            (this._pressed = !1),
                                                            this._updateState());
                                                    }),
                                                    o(r, [
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            set: function (t) {
                                                                this._transition !== t &&
                                                                    (this._transition & Oe.COLOR && this._updateColorTransition(Te.NORMAL),
                                                                    this._transition & Oe.SPRITE && this._updateSpriteTransition(Te.NORMAL),
                                                                    (this._transition = t),
                                                                    this._updateState());
                                                            },
                                                        },
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            set: function (t) {
                                                                if (this._normalSprite !== t) {
                                                                    this._normalSprite = t;
                                                                    var e = this.node.getComponent(x);
                                            ...
                                            (ue = t(ce.prototype, "clickEvents", [Jt, qt], {
                                                configurable: !0,
                                                enumerable: !0,
                                                writable: !0,
                                            ...
                                            (me = t(ce.prototype, "_interactable", [Yt], {
                                                configurable: !0,
                                                enumerable: !0,
                                                writable: !0,
                                                initializer: function () {
                                            ...
                                            (he = t(ce.prototype, "_transition", [Kt], {
                                                configurable: !0,
                                                enumerable: !0,
                                                writable: !0,
                                                initializer: function () {
                                            ...
                                            (ve = t(ce.prototype, "_zoomScale", [ae], {
                                                configurable: !0,
                                                enumerable: !0,
                                                writable: !0,
                                                initializer: function () {
            ...
            ((Be = gi("ColorText")),
                ...
                (Ve = Si({ tooltip: "正片疊底顏色", type: O })),
                (We = Si({ tooltip: "顏色漸變貼圖的範圍", range: [0, 1, 0.01], slide: !0 })),
                (Ue = Si({ tooltip: "是否垂直漸變顏色" })),
                (je = Si({ tooltip: "上內陰影顏色", type: O })),
                (Xe = Si({ tooltip: "下內陰影顏色", type: O })),
                (Je = Si({ tooltip: "上內陰影顏色高度 (Pixel)" })),
                (qe = Si({ tooltip: "下內陰影顏色高度 (Pixel)" })),
                (Ye = Si({ tooltip: "上內陰影插值比例 (0 ~ 1)", range: [0, 1, 0.01], slide: !0 })),
                (Ke = Si({ tooltip: "下內陰影插值比例 (0 ~ 1)", range: [0, 1, 0.01], slide: !0 })),
                Be(
                    (Ze =
                        Fe(
                            (Ze =
                                wi(
                                    ...
                                    t(Qe.prototype, "innerShadowRate1", [Ye], Object.getOwnPropertyDescriptor(Qe.prototype, "innerShadowRate1"), Qe.prototype),
                                    t(Qe.prototype, "innerShadowRate2", [Ke], Object.getOwnPropertyDescriptor(Qe.prototype, "innerShadowRate2"), Qe.prototype),
                                    (Ze = Qe)),
                                ) || Ze),
                        ) || Ze),
                ));
            ...
            var vi,
                Ci = E.ccclass,
                Ei = E.property,
                Oi = E.executeInEditMode;
            ((ui = Ci("ColorFadingUI")),
                (mi = Ei({ type: J, tooltip: "Color Fading 預設 shader" })),
                (hi = Ei({ type: q, tooltip: "Gradient Texture Size" })),
                (pi = Ei({ type: Y, tooltip: "是否使用alpha test, Spine建議開啟" })),
                (_i = Ei({ type: K, tooltip: "混合比例，0~1之間" })),
                (di = Ei({ type: V, tooltip: "當前Gradient" })),
                ui(
                    (fi =
                        Oi(
                            (t(
                                (yi = (function (t) {
                                    ...
                                    return (
                                        ...
                                        (n.GetRenderComponent = function () {
                                            return (
                                                null == this.m_renderComponent && (this.m_renderComponent = this.node.getComponent(x)),
                            ...
                            t(yi.prototype, "MixRate", [_i], Object.getOwnPropertyDescriptor(yi.prototype, "MixRate"), yi.prototype),
                            t(yi.prototype, "CurrentGradient", [di], Object.getOwnPropertyDescriptor(yi.prototype, "CurrentGradient"), yi.prototype),
                            (fi = yi)),
                        ) || fi),
                ));
            ...
            ((Xi.DesignSize = { width: 1136, height: 640 }),
                (Xi.SOUND_FILE = { COMMON_SUPER_WIN: null, COMMON_MEGA_WIN: null, COMMON_COIN_SMALL: null, COMMON_COIN_MEDIUM: null, COMMON_BIG_WIN: null }),
                (Xi.EFFECT_ROOT = "Astt/%s/effect/GameCommonEffect/"),
                (Xi.FILE_PATH = {
                ...
                (Xi.WIN_EFFECT_SOUND_NAME =
                    (((Ti = {})[Xi.FILE_PATH.BIG_WIN] = "Common_big_win"),
                    (Ti[Xi.FILE_PATH.MEGA_WIN] = "Common_mega_win"),
                    (Ti[Xi.FILE_PATH.SUPER_WIN] = "Common_super_win"),
                    (Ti[Xi.FILE_PATH.JACKPOT] = "Common_JP_win"),
                    (Ti[Xi.FILE_PATH.BIG_TO_MEGA_WIN] = "Common_big_win"),
                    (Ti[Xi.FILE_PATH.BIG_TO_SUPER_WIN] = "Common_big_win"),
                    (Ti[Xi.FILE_PATH.FIVE_OF_A_KIND] = "Common_big_win"),
                    Ti)),
                (Xi.EffectViewUIName = tt({ TXT_WIN_MONEY: "label_final_value", PARTICLE: "Particle_" })),
                (Xi.DEFAULT_Y = 400),
                (Xi.PARTICLE_AMOUNT_MAX = 2),
                (Xi.MONEY_ROLL_TIME = 3),
                (Xi.UPDATE_MONEY_CSB = Xi.EFFECT_ROOT + "common_get_coin/Node_GetCoin01.csb"),
                (Xi.COMMON_GET_COIN_CSB = Xi.EFFECT_ROOT + "common_get_coin/Node_GetCoin02.csb"),
                (Xi.GET_COIN_PARTICLE_CSB = Xi.EFFECT_ROOT + "common_get_coin/Particle/_V3_GetCoin02.plist"),
                (Xi.ROTATE_COIN_CSB = Xi.EFFECT_ROOT + "common_get_coin/Node_CoinRotation01.csb"),
                (Xi.TRIAL_COIN_CSB = Xi.EFFECT_ROOT + "common_get_coin/Node_GetTrialCoin.csb"),
                (Xi.COIN_APPEAR_PARTICLE_CSB = Xi.EFFECT_ROOT + "common_get_coin/Particle/New_CoinShine03.plist"),
                (Xi.COMMON_COIN_AMOUNT = 8),
                (Xi.ANI_LABEL = { ACT: "main", LOOP: "loop", ENDING: "ending" }),
                (Xi.ANI_FRAME_EVENT = { MID: "AniMid", B_TO_M: "AniBtoM", M_TO_S: "AniMtoS", ENDING: "AniEnding", END: "AniEnd", LOOP: "AniLoop" }),
                (Xi.EFF_ZORDER = { COIN_FALL: 1, WIN_EFFECT: 2, AWARD_BOARD: 3, COMMON_GET_COIN: 4, GET_TRIAL_COIN: 5 }),
                (Xi.COIN_EFFECT_LIST = {
                    1: Xi.EFFECT_ROOT + "coin/1_SmallGoldCoinFX_1",
                    2: Xi.EFFECT_ROOT + "coin/1_SmallGoldCoinFX_2",
                    3: Xi.EFFECT_ROOT + "coin/1_SmallGoldCoinFX_3",
                    4: Xi.EFFECT_ROOT + "coin/2_BigGoldCoinFX_1",
                    5: Xi.EFFECT_ROOT + "coin/3_MegaGoldCoinFX_1",
                    6: Xi.EFFECT_ROOT + "coin/3_MegaGoldCoinFX_2",
                    7: Xi.EFFECT_ROOT + "coin/3_MegaGoldCoinFX_3",
                }),
                (Xi.WIN_TYPE = { BIG: 2, MEGA: 3, SUPER: 4 }),
                C._RF.pop(),
            ...
            var Ji,
                ...
                an = 0,
                sn = 1;
            ((ki = rn({ type: k, tooltip: "EX 按鈕最頂層節點(整顆node)" })),
                (Ii = rn({ type: ut, tooltip: "EX 按鈕" })),
                (Ai = rn({ type: ut, tooltip: "按鈕ON" })),
                (Ri = rn({ type: ut, tooltip: "按鈕OFF" })),
                (xi = rn({ type: ut, tooltip: "提示問號按鈕" })),
                (Li = rn({ type: k, tooltip: "提示文字tip面板" })),
                (Pi = rn({ type: B, tooltip: "功能說明文字串Label" })),
                (Bi = rn({ type: x, tooltip: "本體ExtraBet文字圖片" })),
                on(
                    ((Di = t(
                        (Mi = (function (t) {
                            function r() {
                            ...
                            return (
                                ...
                                (w.onLoad = function () {
                                    ...
                                    if (!s.CheckSwitchOff(u.CloseExtraBet)) {
                                        (Z("ExtraBet onLoad"),
                                            this.m_multiBtn &&
                                                this.m_multiBtn.node.on(k.EventType.TOUCH_END, function () {
                                        ...
                                        for (var e = 0; e < this.m_multiBtn_on.length; e++)
                                            (this.m_multiBtn_on[e].node.on(k.EventType.TOUCH_END, function () {
                                                t.m_ExtraBetAniPlaying ||
                                                    (t.CheckCanUseBtn() ? t.ChangeBetMode() : p.ShowMessageBox(a.StringKey.FREEWINCASH_PLAYING1));
                                            }),
                                                this.m_multiBtn_off[e] &&
                                                    this.m_multiBtn_off[e].node.on(k.EventType.TOUCH_END, function () {
                                                ...
                                                function (t) {
                                                    for (;;)
                                                        switch ((t.prev = t.next)) {
                                                            ...
                                                            case 2:
                                                                if (
                                                                    (Z("ChangeBetMode stateManager.Current() : ", d.Current()),
                    ...
                    (zi = t(Mi.prototype, "m_multiBtn", [Ii], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Gi = t(Mi.prototype, "m_multiBtn_on", [Ai], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Hi = t(Mi.prototype, "m_multiBtn_off", [Ri], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Vi = t(Mi.prototype, "m_multiBtn_TipQuesMark", [xi], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
            ...
            var ln,
                ...
                zn = E.ccclass,
                Gn = E.property;
            ((Ji = Gn({ type: x, tooltip: "說明文字" })),
                (qi = Gn({ type: mt, tooltip: "圖片名稱" })),
                (Yi = Gn({ type: Boolean, tooltip: "圖片名稱" })),
                (Ki = Gn({ type: x, tooltip: "圖片名稱" })),
                zn(
                    (($i = t(
                        (Qi = (function (t) {
                            function o() {
                    ...
                    (nn = t(Qi.prototype, "m_ADsprite", [Ki], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
            ...
            var Hn,
                ...
                Yn = "active-in-hierarchy-changed";
            (!(function (t) {
            ...
            var Kn, Zn, Qn;
            ((ln = Jn("Chiron/GroupNode/GroupNode")),
                (cn = Xn({ displayName: "Sync OnEnable", tooltip: "當 Node 啟用時同步一次所有選定的狀態至屬性 Group Nodes 中" })),
                (un = Xn({ displayName: "Sync OnDisable", tooltip: "當 Node 啟用時同步一次所有選定的狀態至屬性 Group Nodes 中" })),
                (mn = Xn({ displayName: "Sync Recursive", tooltip: "是否遞迴同步屬性 Group Nodes 中帶有 GroupNode 元件的節點" })),
                (hn = Xn({ type: [k], displayName: "Group Nodes" })),
                (pn = Xn({ displayName: "Active Aware", tooltip: "當啓閉狀態改變時是否讓群組裡的 Node 跟著啓閉調整" })),
                (_n = Xn({ displayName: "Position Aware", tooltip: "當位置改變時是否讓群組裡的 Node 跟著調整相對位置" })),
                (dn = Xn({
                    type: tt(Vn),
                ...
                (fn = Xn({ displayName: "Rotation Aware", tooltip: "當旋轉改變時是否讓群組裡的 Node 跟著調整轉角" })),
                (yn = Xn({ displayName: "Scale Aware", tooltip: "當縮放比例改變時是否讓群組裡的 Node 跟著改變縮放比例" })),
                (gn = Xn({
                    type: tt(Wn),
                ...
                (Sn = Xn({ displayName: "Color Aware", tooltip: "當顏色改變時是否讓群組裡的 Node 跟著改變顏色" })),
                (bn = Xn({
                    type: tt(Un),
                ...
                (wn = Xn({ displayName: "Size Aware", tooltip: "當大小改變時是否讓群組裡的 Node 跟著改變大小" })),
                (vn = Xn({
                    type: tt(Hn),
                        ...
                        qn(
                            (Cn =
                                ln(
                                        ...
                                        (En = (function (t) {
                                            function r() {
                                                ...
                                                return (
                                                    ...
                                                    i(e, "m_syncOnEnable", On, n(e)),
                                                    i(e, "m_syncOnDisable", Tn, n(e)),
                                                    i(e, "m_syncRecursive", Nn, n(e)),
                                                    i(e, "m_nodes", kn, n(e)),
                                                    i(e, "m_activeAware", In, n(e)),
                                                    i(e, "m_positionAware", An, n(e)),
                                                    i(e, "m_positionMode", Rn, n(e)),
                                                    i(e, "m_rotationAware", xn, n(e)),
                                            ...
                                            return (
                                                (a.__preload = function () {
                                                    this.m_isRegisted ||
                                                        ...
                                                        this.node.on(Yn, this.OnActiveChanged, this),
                                                        this.node.on(k.EventType.COLOR_CHANGED, this.OnColorChanged, this),
                                                        this.node.on(k.EventType.TRANSFORM_CHANGED, this.OnRotationChanged, this),
                                                        this.node.on(k.EventType.TRANSFORM_CHANGED, this.OnPositionChanged, this),
                                                        this.node.on(k.EventType.TRANSFORM_CHANGED, this.OnScaleChanged, this),
                                                        this.node.on(k.EventType.SIZE_CHANGED, this.OnSizeChanged, this),
                                                        pt.on(_t.EVENT_BEFORE_DRAW, this.StateCheck, this));
                                                }),
                                                ...
                                                (a.onDestroy = function () {
                                                    (t.prototype.onDestroy && t.prototype.onDestroy.call(this),
                                                        this.node.off(Yn, this.OnActiveChanged, this),
                                                        this.node.off(k.EventType.TRANSFORM_CHANGED, this.OnPositionChanged, this),
                                                        this.node.off(k.EventType.COLOR_CHANGED, this.OnColorChanged, this),
                                                        this.node.off(k.EventType.TRANSFORM_CHANGED, this.OnRotationChanged, this),
                                                        this.node.off(k.EventType.TRANSFORM_CHANGED, this.OnScaleChanged, this),
                                                        this.node.off(k.EventType.SIZE_CHANGED, this.OnSizeChanged, this),
                                                        pt.off(_t.EVENT_BEFORE_DRAW, this.StateCheck, this));
                                                }),
                                                (a.onEnable = function () {
                                                ...
                                                (a.SyncScale = function () {
                                                    if (this.m_scaleAware)
                                                        for (var t, e = w(this.m_nodes); !(t = e()).done; ) {
                                                            var i = t.value;
                                                            i &&
                                                                i.isValid &&
                                                                ((i.scale = new R(this.node.scale.x, this.node.scale.y, this.node.scale.z)),
                                                ...
                                                (a.SyncColor = function () {
                                                    if (this.m_colorAware)
                                                        for (var t, e = this.node.getComponent(M).color, i = w(this.m_nodes); !(t = i()).done; ) {
                                                            var n = t.value;
                                                ...
                                                (a.SyncOpacity = function () {
                                                    if (this.m_colorAware && this.m_colorMode & Un.A)
                                                        for (var t, e = w(this.m_nodes); !(t = e()).done; ) {
                                                            ...
                                                            i &&
                                                                i.isValid &&
                                                                ((i.getComponent(dt).opacity = this.node.getComponent(dt).opacity),
                                                ...
                                                (a.SyncRotation = function () {
                                                    if (this.m_rotationAware) {
                                                        ...
                                                        this.m_lastRotation = this.node.angle;
                                                        for (var e, i = w(this.m_nodes); !(e = i()).done; ) {
                                                            var n = e.value;
                                                ...
                                                (a.SyncActive = function () {
                                                    if (this.m_activeAware)
                                                        for (var t, e = this.node.active, i = w(this.m_nodes); !(t = i()).done; ) {
                                                            var n = t.value;
                                                ...
                                                (a.SyncPosition = function () {
                                                    if (this.m_positionAware) {
                                                        ...
                                                        for (var i, n = w(this.m_nodes); !(i = n()).done; ) {
                                                            var o = i.value;
                                                            o &&
                                                                o.isValid &&
                                    ...
                                    (Tn = t(En.prototype, "m_syncOnDisable", [un], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (In = t(En.prototype, "m_activeAware", [pn], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (An = t(En.prototype, "m_positionAware", [_n], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (Rn = t(En.prototype, "m_positionMode", [dn], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (xn = t(En.prototype, "m_rotationAware", [fn], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (Mn = t(En.prototype, "m_sizeAware", [wn], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (Dn = t(En.prototype, "m_sizeMode", [vn], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
            ...
            var yo,
                ...
                vo = "db://assets/otherAsttText/AsttText/en/";
            !(function (t) {
            ...
            (($n = go("LangImg")),
                ...
                (no = bo({ type: Y, tooltip: "是否為通用圖片" })),
                (oo = bo({ type: Y, tooltip: "是否由這個組件來設定多語系圖片" })),
                $n(
                    (ro =
                        So(
                            ((so = t(
                                    ...
                                    return (
                                        ...
                                        (r.SetImg = function () {
                                            ...
                                            if (this.m_isUsingSetImage) {
                                                ...
                                                var i = this.node.getComponent(x);
                                                (i || (i = this.node.addComponent(x)), (i.spriteFrame = e.getSpriteFrame(this.m_path)));
                                            }
                                        }),
                                                        ...
                                                        function (t) {
                                                            for (;;)
                                                                switch ((t.prev = t.next)) {
                                                                    ...
                                                                    case 2:
                                                                        return (
                                                                            (e = (this.m_isCommon ? vo : wo) + this.m_extraPath + this.m_path),
                                                                            (i = Mo.PNG),
                                                                        ...
                                                                        ((r = t.sent),
                                                                            ...
                                                                            P.loadAny(a, function (t, e) {
                                                                                if (t) et("Failed to load cc.SpriteFrame resources:", t);
                                                                                    ...
                                                                                    var i = s.node.getComponent(x);
                                                                                    (i || (i = s.node.addComponent(x)), (i.spriteFrame = e));
                                                                                }
                                                                            }));
                                                                    case 11:
                                                                    case "end":
            ...
            var Do,
                ...
                Jo = E.ccclass,
                qo = E.property;
            ((Co = qo({ type: K, tooltip: "每秒的位移量" })),
                (Eo = qo({ type: K, tooltip: "循環播放的間隔" })),
                (Oo = qo({ type: K, tooltip: "未超出的停留時間" })),
                (To = qo({ type: K, tooltip: "超出時的停留時間" })),
                (No = qo({ type: K, tooltip: "尾部保留的空間" })),
                (ko = qo({ type: k, tooltip: "跑馬燈內容節點" })),
                Jo(
                    ((Ro = t(
                        (Ao = (function (t) {
                            function o() {
                                ...
                                return (
                                    (e = t.call.apply(t, [this].concat(r)) || this),
                                    i(e, "m_moveSpeed", Ro, n(e)),
                                    i(e, "m_delayTime", xo, n(e)),
                            ...
                            return (
                                (r.Init = function (t) {
                                    ...
                                    (t &&
                                        t.length > 0 &&
                                        (e || ((e = new k()).addComponent(N), this.node.addChild(e)),
                                        (this.m_stringSprite = e.getComponent(x)),
                                        this.m_stringSprite || (this.m_stringSprite = e.addComponent(x)),
                                        (this.m_stringSprite.type = x.Type.SIMPLE),
                                        (this.m_stringSprite.sizeMode = x.SizeMode.TRIMMED)),
                    ...
                    (xo = t(Ao.prototype, "m_delayTime", [Eo], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Lo = t(Ao.prototype, "m_waitTime", [Oo], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Po = t(Ao.prototype, "m_moveDelayTime", [To], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Bo = t(Ao.prototype, "m_tailLeftSpace", [No], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Fo = t(Ao.prototype, "m_content", [ko], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
            ...
            ((Do = nr("NearWinEffectComponent")),
                ...
                (Ho = or({ type: Y, tooltip: "是否使用spine動畫" })),
                Do(
                    ((Uo = t(
                        (Wo = (function (t) {
                            function o() {
                                                    ...
                                                    for (;;)
                                                        switch ((t.prev = t.next)) {
                                                            case 0:
                                                                ...
                                                                return ((t.next = 5), v.PlayAnimation(this.m_spine, tr));
                                                            case 5:
                                                                (t.sent || v.PlayAnimation(this.m_spine, ir, !0), (t.next = 16));
                                                                break;
                                                            case 9:
                                                                return (
                                                ...
                                                function (t) {
                                                    for (;;)
                                                        switch ((t.prev = t.next)) {
                                                            ...
                                                            case 4:
                                                                return (this.CheckSpine(), (t.next = 7), v.PlayAnimation(this.m_spine, er));
                                                            case 7:
                    ...
                    (Xo = t(Wo.prototype, "m_isPlaySpine", [Ho], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
            ...
            var rr,
                ...
                pr = E.ccclass,
                _r = E.property;
            ((Yo = pr("RenderDataBump")),
                (Ko = _r({ tooltip: "是否一同影響子節點" })),
                Yo(
                    (($o = t(
                        (Qo = (function (t) {
                            function o() {
                            ...
                            return (
                                (r.onLoad = function () {
                                    this.node.on(k.EventType.PARENT_CHANGED, this.checkStates, this);
                                }),
                                (r.onDestroy = function () {
                                    this.node.off(k.EventType.PARENT_CHANGED, this.checkStates, this);
                                }),
            ...
            ((rr = Sr("ScrollEventHandler")),
                (ar = br({ type: k, tooltip: "真實放置內容的節點，有自行分層請把每一層的根節點放進去" })),
                rr(
                    ((cr = t(
                        (lr = (function (t) {
                            function r() {
            ...
            var wr,
                ...
                ma = E.ccclass;
            ((dr = (0, E.property)({ type: $.Skeleton, tooltip: "spine" })),
                ma(
                    ((gr = t(
                        (yr = (function (t) {
                            function o() {
                            ...
                            return (
                                                        ...
                                                        switch ((t.prev = t.next)) {
                                                            case 0:
                                                                return (
                                                                    ...
                                                                    (t.next = 6),
                                                                    v.PlayAnimation(this.m_spine, n, !1, 0, o)
                                                                );
                                                            case 6:
                                                                this.node.active = !1;
                                                            case 7:
                                ...
                                (r.Prepare = function (t) {
                                    ((this.node.active = !0),
                                        ...
                                        v.PlayAnimation(this.m_spine, t ? ra : aa),
                                ...
                                (r.Rotation = function (t) {
                                    if (this.node.active) {
                                        ...
                                        ((this.m_spine.paused = !1),
                                            this.m_spine.clearTracks(),
                                            this.m_spine.setToSetupPose(),
                                            v.PlayAnimation(this.m_spine, e),
                                            (this.m_spine.paused = !0));
                                    }
                                }),
                                o
            ...
            var ba,
                wa = tt({ None: ha.None, FadeIn: ha.FadeIn, FadeOut: ha.FadeOut }),
                va = function (t) {
                    var e,
                        i = 0;
                ...
                Ca =
                    ((wr = pa("_TweenInfo")),
                    (vr = _a({ visible: !1, tooltip: "Easing" })),
                    (Cr = _a({ type: ga, visible: !1 })),
                    (Er = _a({ visible: !0, displayName: "緩動效果", type: ga })),
                    (Or = _a({ type: wa, visible: !1 })),
                    (Tr = _a({ visible: !0, displayName: "fade type", type: wa })),
                    (Nr = _a({ min: 0, visible: !0, displayName: "時間" })),
                    wr(
                        ((Ar = t(
                            (Ir = (function () {
                                function t() {
                                    (i(this, "m_EasingName", Ar, this),
                                        i(this, "__easingIdx", Rr, this),
                                        i(this, "__fadeType", xr, this),
                        ...
                        (Rr = t(Ir.prototype, "__easingIdx", [Cr], {
                            configurable: !0,
                            enumerable: !0,
                            writable: !0,
                            initializer: function () {
                        ...
                        t(Ir.prototype, "_easingIdx", [Er], Object.getOwnPropertyDescriptor(Ir.prototype, "_easingIdx"), Ir.prototype),
                        (xr = t(Ir.prototype, "__fadeType", [Or], {
                            configurable: !0,
                            enumerable: !0,
                            writable: !0,
                            initializer: function () {
                        ...
                        t(Ir.prototype, "_fadeType", [Tr], Object.getOwnPropertyDescriptor(Ir.prototype, "_fadeType"), Ir.prototype),
                        (Lr = t(Ir.prototype, "duration", [Nr], {
                            configurable: !0,
                            enumerable: !0,
                            writable: !0,
                            initializer: function () {
            ...
            ((Pr = pa("Shake")),
                ...
                (Fr = _a({ visible: !1, displayName: "正負交替", tooltip: "重複次數>1時, 正負交替" })),
                (Mr = _a({
                    type: St,
                ...
                (Dr = _a({ visible: !0, tooltip: "自定義的shake name" })),
                (zr = _a({ type: Sa, visible: !1 })),
                (Gr = _a({ visible: !0, displayName: "儲存到預先定義.json", tooltip: "若Shakename不為:custom,才會儲存" })),
                (Hr = _a({ visible: !0, displayName: "預先定義", tooltip: "切換後會以預先定義的數值直接覆蓋所有設定值", type: Sa })),
                (Vr = _a({ readonly: !0, displayName: "總震動時間" })),
                (Wr = _a({ visible: !0, displayName: "振幅" })),
                (Ur = _a({ min: 1, step: 1, visible: !0, displayName: "震動頻率/秒" })),
                (jr = _a({ step: 1, visible: !0, displayName: "振幅x/y/z權重:%" })),
                (Xr = _a({ visible: !1, type: [Ca] })),
                (Jr = _a({ type: [Ca], tooltip: "輸入更改 緩動效果 數量", displayName: "緩動效果" })),
                Pr(
                    (qr =
                        da(
                            (qr =
                                Br(
                                            ...
                                            return (
                                                ...
                                                (a.onLoad = function () {
                                                    ...
                                                    for (var t = [], e = 0; e < ya.length; ++e) {
                                                        var i = ya[e];
                                                        t.push({ name: i.desc, easingName: i.name, value: va(i.name) });
                                                    }
                                                    (t.sort(function (t, e) {
                                                ...
                                                (a.fade = function (t, e, i, n, o, r, a) {
                                                    ...
                                                    for (var s = 1 / i, l = e / s, c = 1; c <= l; c++) {
                                                        ...
                                                        var m = this.originPos.clone(),
                                                            h = new R(L.random() - 0.5, L.random() - 0.5, L.random() - 0.5),
                                                            p = new R((2 * u * r.x) / 100, (2 * u * r.y) / 100, (2 * u * r.z) / 100);
                                                        ((p = p.multiply(h)),
                                                            (m = m.add(p)),
                                                            (t = t.to(
                                                                s,
                                                ...
                                                (a.ShakeWithName = function (t) {
                                                    if (this.shakeJson && this.shakeJson.json.shakelist) {
                                                        ...
                                                        var i = e[t],
                                                            n = i._TweenList,
                                                            o = i.weight;
                                                        this._shake(n, i.frequency, i.magnitude, new R(o.x, o.y, o.z));
                                                    } else console.log("ShakeWithName shakeJson not assign!");
                                                }),
                                    ...
                                    (Zr = t(Yr.prototype, "shakeJson", [Mr], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (Qr = t(Yr.prototype, "shakename", [Dr], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    ($r = t(Yr.prototype, "__ShakeIdx", [zr], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    t(Yr.prototype, "saveshake", [Gr], Object.getOwnPropertyDescriptor(Yr.prototype, "saveshake"), Yr.prototype),
                                    t(Yr.prototype, "_ShakeIdx", [Hr], Object.getOwnPropertyDescriptor(Yr.prototype, "_ShakeIdx"), Yr.prototype),
                                    (ta = t(Yr.prototype, "Duration", [Vr], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (ea = t(Yr.prototype, "magnitude", [Wr], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (ia = t(Yr.prototype, "frequency", [Ur], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    (oa = t(Yr.prototype, "_TweenList", [Xr], {
                                        configurable: !0,
                                        enumerable: !0,
                                        writable: !0,
                                        initializer: function () {
                                    ...
                                    t(Yr.prototype, "TweenList", [Jr], Object.getOwnPropertyDescriptor(Yr.prototype, "TweenList"), Yr.prototype),
                                    (qr = Yr)),
                                ) || qr),
                        ) || qr),
                ));
            ...
            var fs,
                ...
                el;
            ((Ea = ls("BoneFollow")),
                (Oa = us("Chiron/Spine/BoneFollow")),
                (Ta = cs({ type: $.Skeleton, tooltip: "目標 Spine 骨架" })),
                (Na = cs({ tooltip: "目標同步骨骼名稱" })),
                (ka = cs({
                    tooltip:
                        "是否快取旋轉及縮放的上層資料，預設開啟。如果父層以上會有動態調整旋轉及縮放則需取消勾選此選項，或是維持啟用狀態但於需要的時刻呼叫 CacheUpdate 方法",
                })),
                (Ia = cs({ tooltip: "是否同步位置" })),
                (Aa = cs({ tooltip: "是否同步旋轉" })),
                (Ra = cs({ tooltip: "是否將目標旋轉角度轉換成區域旋轉角度" })),
                (xa = cs({ tooltip: "是否同步縮放" })),
                ...
                Ea(
                    (Ha =
                        Oa(
                            (((os = (function (t) {
                                function o() {
                                    ...
                                    return (
                                        ...
                                        i(e, "m_isFollowPosition", Xa, n(e)),
                                        i(e, "m_isFollowRotation", Ja, n(e)),
                                        i(e, "m_isRotationLocalization", qa, n(e)),
                                        i(e, "m_isFollowScale", Ya, n(e)),
                                        i(e, "m_isScaleLocalization", Ka, n(e)),
                                        ...
                                        if (
                                            ...
                                            if ((t = this.m_spineSkeleton.findBone(this.m_boneName))) {
                                                ...
                                                if (
                                                    ...
                                                    var m = t.parent,
                                                        h = t.arotation;
                                                    this.node.angle = e + (bt(m) ? ds(m.a, m.b, m.c, m.d, h) : t.arotation) + this.m_rotationFactor;
                                                }
                                                if (
                                                    ...
                                                    var p = this.m_spineSkeleton.node.getComponent(N).convertToWorldSpaceAR(at(t.worldX, t.worldY, 0)),
                                                        _ = this.node.parent.getComponent(N).convertToNodeSpaceAR(p);
                            ...
                            (Wa = t((Va = os).prototype, "m_spineSkeleton", [Ta], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (ja = t(Va.prototype, "m_isCacheData", [ka], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Xa = t(Va.prototype, "m_isFollowPosition", [Ia], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Ja = t(Va.prototype, "m_isFollowRotation", [Aa], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (qa = t(Va.prototype, "m_isRotationLocalization", [Ra], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Ya = t(Va.prototype, "m_isFollowScale", [xa], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Ka = t(Va.prototype, "m_isScaleLocalization", [La], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
            ...
            (C._RF.pop(), C._RF.push({}, "44834DdFVNM2reoglp7HL82", "NewBoneFollow", void 0));
            var il,
                nl = E.ccclass,
                ol = E.property,
                rl = E.executeInEditMode;
            !(function (t) {
            ...
            function cl(t, e, i, n, o) {
                var r,
                    a = ((r = o), Math.sin(r * ll)),
                    s = (function (t) {
                        return Math.cos(t * ll);
                    })(o);
                return 57.29577866666166 * Math.atan2(s * i + a * n, s * t + a * e);
            }
            var ul, ml, hl, pl, _l, dl, fl, yl, gl, Sl, bl, wl, vl, Cl, El, Ol, Tl, Nl;
            ((fs = nl("NewBoneFollow")),
                (ys = ol({ visible: !1, tooltip: "目標 Spine 骨架" })),
                (gs = ol({
                    visible: !1,
                    tooltip:
                        "是否快取旋轉及縮放的上層資料，預設開啟。如果父層以上會有動態調整旋轉及縮放則需取消勾選此選項，或是維持啟用狀態但於需要的時刻呼叫 CacheUpdate 方法",
                })),
                (Ss = ol({ visible: !1, tooltip: "是否同步位置" })),
                (bs = ol({ visible: !1, tooltip: "是否同步旋轉" })),
                (ws = ol({ visible: !1, tooltip: "是否將目標旋轉角度轉換成區域旋轉角度" })),
                (vs = ol({ visible: !1, tooltip: "是否同步縮放" })),
                (Cs = ol({ visible: !1, tooltip: "是否將目標縮放量轉換成區域縮放量" })),
                (Es = ol({ visible: !0, displayName: "Preview" })),
                (Os = ol({ type: $.Skeleton, visible: !1 })),
                (Ts = ol({ visible: !0, type: $.Skeleton, displayName: "Skeleton", tooltip: "目標 Spine 骨架" })),
                (Ns = ol({ visible: !1 })),
                (ks = ol({ visible: !0, displayName: "BoneName", tooltip: "請輸入要跟隨的 Spine 骨頭名稱或從下拉選單選擇" })),
                (Is = ol({ type: al, visible: !1 })),
                (As = ol({ type: al, visible: !0, displayName: "SelectFromList", tooltip: "可從此下拉選單選擇骨頭" })),
                (Rs = ol({
                    displayName: "Cache Ancestors",
                    tooltip:
                        "是否快取旋轉及縮放的上層資料，預設開啟。如果父層以上會有動態調整旋轉及縮放則需取消勾選此選項，或是維持啟用狀態但於需要的時刻呼叫 CacheUpdate 方法",
                })),
                (xs = ol({ displayName: "Position", tooltip: "是否同步位置" })),
                (Ls = ol({
                    displayName: "Position Offset",
                    tooltip: "額外本體位置偏移",
                    visible: function () {
                ...
                (Ps = ol({ displayName: "Rotation", tooltip: "是否同步旋轉" })),
                (Bs = ol({
                ...
                (Ms = ol({ displayName: "Scale", tooltip: "是否同步縮放" })),
                (Ds = ol({
                ...
                fs(
                    (Gs =
                        rl(
                            (((el = (function (t) {
                                function r() {
                                    ...
                                    return (
                                        ...
                                        (e._cachedScaleY = 1),
                                        (e._BoneEnumList = []),
                                        i(e, "m_preview", Vs, n(e)),
                                        i(e, "m_spineSkeleton", Ws, n(e)),
                                        i(e, "m_boneName", Us, n(e)),
                                        i(e, "__boneIndex", js, n(e)),
                                        i(e, "m_cacheAncestors", Xs, n(e)),
                                        i(e, "m_followPosition", Js, n(e)),
                                        i(e, "m_positionOffset", qs, n(e)),
                                        i(e, "m_followRotation", Ys, n(e)),
                                        i(e, "m_rotationLocalization", Ks, n(e)),
                                        i(e, "m_rotationFactor", Zs, n(e)),
                                        i(e, "m_followScale", Qs, n(e)),
                                        i(e, "m_scaleLocalization", $s, n(e)),
                                        i(e, "m_scaleFactor", tl, n(e)),
                                        (e.m_isFirstActive = !0),
                                        e
                                    );
                                }
                                ...
                                return (
                                    ...
                                    (a.start = function () {}),
                                    (a.onEnable = function () {
                                        pt.on(_t.EVENT_BEFORE_DRAW, this.BoneSync, this);
                                    }),
                                    (a.onDisable = function () {
                                        pt.off(_t.EVENT_BEFORE_DRAW, this.BoneSync, this);
                                    }),
                                    (a.onDestroy = function () {
                                        ((this._oldAngle = null),
                                            (this._oldScaleX = null),
                                        ...
                                        if (
                                            ...
                                            if (t) {
                                                ...
                                                if (
                                                    ...
                                                    var m = t.parent,
                                                        h = t.arotation,
                                                        p = e + (bt(m) ? cl(m.a, m.b, m.c, m.d, h) : t.arotation) + this.m_rotationFactor;
                                                    this.node.setRotationFromEuler(at(0, 0, p));
                                                }
                                                if (
                                                    (this.m_followScale &&
                                                        this.node.setScale(
                            ...
                            t((Hs = el).prototype, "Skeleton", [ys], Object.getOwnPropertyDescriptor(Hs.prototype, "Skeleton"), Hs.prototype),
                            t(Hs.prototype, "CacheData", [gs], Object.getOwnPropertyDescriptor(Hs.prototype, "CacheData"), Hs.prototype),
                            t(Hs.prototype, "FollowPosition", [Ss], Object.getOwnPropertyDescriptor(Hs.prototype, "FollowPosition"), Hs.prototype),
                            t(Hs.prototype, "FollowRotation", [bs], Object.getOwnPropertyDescriptor(Hs.prototype, "FollowRotation"), Hs.prototype),
                            t(Hs.prototype, "RotationLocalization", [ws], Object.getOwnPropertyDescriptor(Hs.prototype, "RotationLocalization"), Hs.prototype),
                            t(Hs.prototype, "FollowScale", [vs], Object.getOwnPropertyDescriptor(Hs.prototype, "FollowScale"), Hs.prototype),
                            t(Hs.prototype, "ScaleLocalization", [Cs], Object.getOwnPropertyDescriptor(Hs.prototype, "ScaleLocalization"), Hs.prototype),
                            (Vs = t(Hs.prototype, "m_preview", [Es], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Ws = t(Hs.prototype, "m_spineSkeleton", [Os], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            t(Hs.prototype, "_spineSkeleton", [Ts], Object.getOwnPropertyDescriptor(Hs.prototype, "_spineSkeleton"), Hs.prototype),
                            (Us = t(Hs.prototype, "m_boneName", [Ns], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            t(Hs.prototype, "BoneName", [ks], Object.getOwnPropertyDescriptor(Hs.prototype, "BoneName"), Hs.prototype),
                            (js = t(Hs.prototype, "__boneIndex", [Is], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            t(Hs.prototype, "_boneIndex", [As], Object.getOwnPropertyDescriptor(Hs.prototype, "_boneIndex"), Hs.prototype),
                            (Xs = t(Hs.prototype, "m_cacheAncestors", [Rs], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Js = t(Hs.prototype, "m_followPosition", [xs], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (qs = t(Hs.prototype, "m_positionOffset", [Ls], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Ys = t(Hs.prototype, "m_followRotation", [Ps], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Ks = t(Hs.prototype, "m_rotationLocalization", [Bs], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Zs = t(Hs.prototype, "m_rotationFactor", [Fs], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Qs = t(Hs.prototype, "m_followScale", [Ms], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            ($s = t(Hs.prototype, "m_scaleLocalization", [Ds], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (tl = t(Hs.prototype, "m_scaleFactor", [zs], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
            ...
            var xl,
                ...
                Ml,
                Dl = tt({});
            ((ul = Il("NewSlotColorFollow")),
                (ml = Al({ visible: !1, tooltip: "目標 Spine 骨架" })),
                (hl = Al({ visible: !0, displayName: "Preview" })),
                (pl = Al({ visible: !1 })),
                (_l = Al({ type: $.Skeleton, visible: !1 })),
                (dl = Al({ visible: !0, type: $.Skeleton, displayName: "Skeleton", tooltip: "目標 Spine 骨架" })),
                (fl = Al({ visible: !1 })),
                (yl = Al({ visible: !0, displayName: "SlotName", tooltip: "請輸入要跟隨的 Spine 插槽名稱或從下拉選單選擇" })),
                (gl = Al({ type: Dl, visible: !1 })),
                (Sl = Al({ visible: !0, displayName: "SelectFromList", type: Dl, tooltip: "可從此下拉選單選擇插槽" })),
                ul(
                    (bl =
                        Rl(
                            (((Nl = (function (t) {
                                function r() {
                                    ...
                                    return (
                                        (e = t.call.apply(t, [this].concat(r)) || this),
                                        i(e, "m_preview", vl, n(e)),
                                        i(e, "_colorCache", Cl, n(e)),
                                        i(e, "m_spineSkeleton", El, n(e)),
                                        i(e, "m_slotName", Ol, n(e)),
                                        i(e, "__slotIndex", Tl, n(e)),
                                        (e._SlotEnumList = []),
                                        e
                                    );
                                }
                                ...
                                return (
                                    ...
                                    (a.start = function () {}),
                                    (a.onEnable = function () {
                                        (this.ColorSync(), pt.on(_t.EVENT_BEFORE_DRAW, this.ColorSync, this));
                                    }),
                                    (a.onDisable = function () {
                                        pt.off(_t.EVENT_BEFORE_DRAW, this.ColorSync, this);
                                    }),
                                    (a.onDestroy = function () {
                                    ...
                                    (a.ColorSync = function () {
                                        if (this.m_spineSkeleton && "" != this.m_slotName) {
                                            ...
                                            (null != this._colorCache &&
                                                ...
                                                this.node.getComponent(x)
                                                    ? ((this.node.getComponent(x).color = X(e, i, n, o)), this._colorCache.set(this.node.getComponent(x).color))
                                                    : this.node.getComponent(B) &&
                                                      ((this.node.getComponent(B).color = X(e, i, n, o)),
                                                      this._colorCache.set(this.node.getComponent(B).color)),
                                                this.node.getComponent(dt) && (this.node.getComponent(dt).opacity = o),
                            ...
                            t((wl = Nl).prototype, "Skeleton", [ml], Object.getOwnPropertyDescriptor(wl.prototype, "Skeleton"), wl.prototype),
                            (vl = t(wl.prototype, "m_preview", [hl], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (Cl = t(wl.prototype, "_colorCache", [pl], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (El = t(wl.prototype, "m_spineSkeleton", [_l], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            t(wl.prototype, "_spineSkeleton", [dl], Object.getOwnPropertyDescriptor(wl.prototype, "_spineSkeleton"), wl.prototype),
                            (Ol = t(wl.prototype, "m_slotName", [fl], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            t(wl.prototype, "SlotName", [yl], Object.getOwnPropertyDescriptor(wl.prototype, "SlotName"), wl.prototype),
                            (Tl = t(wl.prototype, "__slotIndex", [gl], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            t(wl.prototype, "_slotIndex", [Sl], Object.getOwnPropertyDescriptor(wl.prototype, "_slotIndex"), wl.prototype),
                            (bl = wl)),
                        ) || bl),
                ));
            ...
            var zl,
                ...
                Wl = E.menu;
            ((xl = Hl("SkeletonSync")),
                (Ll = Wl("Chiron/Spine/SkeletonSync")),
                (Pl = Vl({ displayName: "Overlap", tooltip: "是否交疊並同步座標、旋轉及縮放" })),
                xl(
                    (Bl =
                        Ll(
                            ((Ml = t(
                                (Fl = (function (t) {
                                    function r() {
                                        for (var e, o = arguments.length, r = new Array(o), a = 0; a < o; a++) r[a] = arguments[a];
                                        return (((e = t.call.apply(t, [this].concat(r)) || this).m_skeleton = null), i(e, "m_overlap", Ml, n(e)), e);
                                    }
                                    e(r, t);
                                    var a = r.prototype;
                                    return (
            ...
            var Ul,
                ...
                lc,
                cc = E.ccclass,
                uc = (E.property, E.menu);
            cc("SlotActivator")(
                (zl =
                    uc("Chiron/Spine/SlotActivator")(
                        (((Gl = (function (t) {
                            function i() {
            ...
            var mc = E.ccclass,
                hc = E.property,
                pc = E.menu,
                _c = (E.inspector, tt({ None: 0 }));
            var dc, fc, yc, gc, Sc, bc, wc, vc;
            ((Ul = mc("SlotColorFollow")),
                (jl = pc("Chiron/Spine/SlotColorFollow")),
                (Xl = hc({ visible: !1, tooltip: "目標 Spine 骨架" })),
                (Jl = hc({ visible: !1, tooltip: "目標同步 slot 名稱" })),
                (ql = hc({ visible: !0, displayName: "Preview" })),
                (Yl = hc({ visible: !1, type: L.Color })),
                (Kl = hc({ visible: !1, type: $.Skeleton })),
                (Zl = hc({ visible: !0, displayName: "Skeleton", tooltip: "目標 Spine 骨架", type: $.Skeleton })),
                (Ql = hc({ visible: !1, tooltip: "目標同步 slot 名稱" })),
                ($l = hc({ visible: !1 })),
                (tc = hc({ visible: !0, displayName: "Slot", type: _c })),
                Ul(
                    (ec =
                        jl(
                            (((lc = (function (t) {
                                function r() {
                                    ...
                                    return (
                                        ((e = t.call.apply(t, [this].concat(r)) || this).editor = void 0),
                                        i(e, "m_preview", nc, n(e)),
                                        i(e, "_colorCache", oc, n(e)),
                                        i(e, "m_spineSkeleton", rc, n(e)),
                                        i(e, "m_slotName", ac, n(e)),
                                        i(e, "__slotIndex", sc, n(e)),
                                        e
                                    );
                                }
                                e(r, t);
                                ...
                                return (
                                    ...
                                    (a.onLoad = function () {
                                        this.node.getComponent(x)
                                            ? (this._colorCache = this.node.getComponent(x).color)
                            ...
                            t((ic = lc).prototype, "Skeleton", [Xl], Object.getOwnPropertyDescriptor(ic.prototype, "Skeleton"), ic.prototype),
                            t(ic.prototype, "SlotName", [Jl], Object.getOwnPropertyDescriptor(ic.prototype, "SlotName"), ic.prototype),
                            (nc = t(ic.prototype, "m_preview", [ql], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (oc = t(ic.prototype, "_colorCache", [Yl], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (rc = t(ic.prototype, "m_spineSkeleton", [Kl], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            t(ic.prototype, "_spineSkeleton", [Zl], Object.getOwnPropertyDescriptor(ic.prototype, "_spineSkeleton"), ic.prototype),
                            (ac = t(ic.prototype, "m_slotName", [Ql], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            (sc = t(ic.prototype, "__slotIndex", [$l], {
                                configurable: !0,
                                enumerable: !0,
                                writable: !0,
                                initializer: function () {
                            ...
                            t(ic.prototype, "_slotIndex", [tc], Object.getOwnPropertyDescriptor(ic.prototype, "_slotIndex"), ic.prototype),
                            (ec = ic)),
                        ) || ec),
                ));
            ...
            var Cc = E.ccclass,
                ...
                Oc = E.menu;
            ((dc = Cc("SlotCulling")),
                (fc = Oc("Chiron/Spine/SlotCulling")),
                (yc = Ec({ visible: !1, tooltip: "目標 Spine 骨架" })),
                (gc = Ec({ visible: !1, tooltip: "反向剔除 Slot 項目(勾選的不會被剔除，未勾選的將被剔除)" })),
                (Sc = Ec({ visible: !1, tooltip: "遭剔除的 Slot 項目名稱" })),
                dc(
                    (bc =
                        fc(
                            (((vc = (function (t) {
                            ...
                            t((wc = vc).prototype, "Skeleton", [yc], Object.getOwnPropertyDescriptor(wc.prototype, "Skeleton"), wc.prototype),
                            t(wc.prototype, "Invert", [gc], Object.getOwnPropertyDescriptor(wc.prototype, "Invert"), wc.prototype),
                            t(wc.prototype, "CullingList", [Sc], Object.getOwnPropertyDescriptor(wc.prototype, "CullingList"), wc.prototype),
                            (bc = wc)),
                        ) || bc),
                ));
            (C._RF.pop(),
                        ...
                        (e.init = function () {
                            if (globalThis.fflate) {
                                ...
                                Object.defineProperty(XMLHttpRequest.prototype, "response", {
                                    get: function () {
                                        return this.ZipCacheUrl ? Nc.get(this.ZipCacheUrl) : t.get.call(this);
                                    },
                                    set: function (t) {},
                                    configurable: !0,
                                });
                                ...
                                XMLHttpRequest.prototype.open = function (t, i, n, o, r) {
                                    function a() {
                                        ...
                                        (this.readyState != XMLHttpRequest.DONE || t || Ic.includes(i) || (Ic.push(i), Rc(701, this.status), Rc(702, i)),
                                            this.removeEventListener("load", a));
                                    }
                                    return (Tc.has(i) && (this.ZipCacheUrl = i), this.addEventListener("load", a.bind(this)), e.apply(this, arguments));
                                };
                                                ...
                                                for (;;)
                                                    switch ((t.prev = t.next)) {
                                                        case 0:
                                                            ...
                                                            if (Nc.has(this.ZipCacheUrl)) {
                                                                t.next = 24;
                                                                break;
                                                            }
                                                            ((n = this.responseType),
                                                                (o = Tc.get(this.ZipCacheUrl)),
                                                                (r = null),
                                                                (t.t0 = n),
                                                        ...
                                                        case 18:
                                                            ((c = kc.get(this.ZipCacheUrl)) &&
                                                                (Nc.delete(this.ZipCacheUrl + "@version" + c), kc.delete(this.ZipCacheUrl)),
                                                                (u = performance.now()),
                                                                kc.set(this.ZipCacheUrl, u),
                                                                (this.ZipCacheUrl = this.ZipCacheUrl + "@version" + u),
                                                                Nc.set(this.ZipCacheUrl, r));
                                                        case 24:
            ...
            function Rc(t, e) {
                if (!vt.isNative) {
                    ...
                    if (-1 == i.indexOf("localhost") && 1 != /^http(s)?:\/\/([0-9]{1,3}\.){3}[0-9]{1,3}(:[0-9]+)?\/.*?$/.test(i)) {
                        var n = 0;
                        switch (vt.browserType) {
                            case vt.BrowserType.CHROME:
                                n = 1;
                                break;
                            case vt.BrowserType.SAFARI:
                                n = 2;
                                break;
                            case vt.BrowserType.IE:
                                n = 3;
                                break;
                            case vt.BrowserType.UC:
                                n = 4;
                                break;
                            case vt.BrowserType.QQ:
                            case vt.BrowserType.MOBILE_QQ:
                                n = 5;
                                break;
                            case vt.BrowserType.FIREFOX:
                                n = 6;
                        }
                        var o = 0;
                        switch (vt.os) {
                        ...
                        var r = xc("apiId") || "-1",
                            a = xc("ssoKey") || "1",
                            s = xc("gameID") || "-1",
                            l = "https://" + (xc("domain_platform") || xc("gs") || "gnidnawcs").split("").reverse().join("") + "/webservice/event/assetUpdate?";
                        (function (t) {
            ...
            var Lc,
                ...
                Yu,
                Ku,
                Zu = globalThis.__zipBundleLoader;
            (globalThis.fflate && !Zu && ((Zu = new Ac()), (globalThis.__zipBundleLoader = Zu), Zu.init()),
                C._RF.pop(),
            ...
            var im,
                ...
                am = rm.EN,
                sm = [10830, 10827, 10778, 10718, 10689, 10651, 10630, 10598, 10505, 10504, 10450, 10414, 10263, 10220],
                lm = [3],
                cm = { JILI: 0, TADA: 1, ACE_ROYALE: 2, JILI_START: 3, TADA_CASINO: 4, NONE: 5, UFA: 6 };
            (!(function (t) {
                ((t[(t.None = 0)] = "None"),
            ...
            var um,
                ...
                vm =
                    ((Lc = tm("StyleSetting")),
                    (Pc = em({ type: Y, tooltip: "是否有骰子造型" })),
                    (Bc = em({ type: Y, tooltip: "是否有萬聖造型" })),
                    (Fc = em({ type: Y, tooltip: "是否有聖誕造型" })),
                    (Mc = em({ type: Y, tooltip: "是否有OKBET廠商造型" })),
                    (Dc = em({ type: tt(nm), tooltip: "系列" })),
                    Lc(
                        ((Hc = t(
                            (Gc = function () {
                                (i(this, "HasDice", Hc, this),
                                    i(this, "HasHolloween", Vc, this),
                                    i(this, "HasXmas", Wc, this),
                                    i(this, "HasOkbet", Uc, this),
                                    i(this, "Series", jc, this));
                            }).prototype,
                            "HasDice",
                            [Pc],
                            {
                        ...
                        (Vc = t(Gc.prototype, "HasHolloween", [Bc], {
                            configurable: !0,
                            enumerable: !0,
                            writable: !0,
                            initializer: function () {
                ...
                Cm =
                    ((Xc = tm("PlayTypeSetting")),
                    (Jc = em({ type: Y, tooltip: "Match" })),
                    (qc = em({ type: Y, tooltip: "Break" })),
                    Xc(
                        ((Zc = t(
                            (Kc = function () {
                                (i(this, "Match", Zc, this), i(this, "Break", Qc, this));
                            }).prototype,
                            "Match",
                            [Jc],
                            {
            ...
            (($c = em({ type: mt, tooltip: "遊戲縮寫(server位置)" })),
                (tu = em({ type: String, tooltip: "遊戲主場prefab路徑" })),
                (eu = em({ type: String, tooltip: "遊戲多語系圖片路徑" })),
                (iu = em({ type: String, tooltip: "遊戲ID" })),
                (nu = em({ type: String, tooltip: "Logo名稱，只要給到底線之前" })),
                (ou = em({ type: Boolean, tooltip: "鎖定橫版" })),
                (ru = em({ type: Boolean, tooltip: "鎖定直版" })),
                (au = em({ type: Boolean, tooltip: "是否為街機" })),
                (su = em({ type: I, tooltip: "不分語系LOGO" })),
                (lu = em({ type: Ct, tooltip: "遊戲Logo合圖" })),
                (cu = em({ type: mt, tooltip: "展示頁" })),
                (uu = em({ type: String, tooltip: "敘述圖名稱" })),
                (mu = em({ type: I, tooltip: "特色圖" })),
                (hu = em({ type: I, tooltip: "背景圖，0:直,1:橫" })),
                (pu = em({ type: I, tooltip: "腳色" })),
                (_u = em({ type: Number, tooltip: "辣椒數" })),
                (du = em({ type: Number, tooltip: "最大贏分倍率" })),
                (fu = em({ type: tt(im), tooltip: "自動玩介面" })),
                (yu = em({ type: Y, tooltip: "是否開啟晚3秒ShowGameScene進入遊戲" })),
                (gu = em({ type: Y, tooltip: "可以跳過前導動畫" })),
                (Su = em({ type: vm, tooltip: "是否有其他特色樣式" })),
                (bu = em({ type: Cm, tooltip: "是否有其他特色樣式" })),
                (wu = em({ type: Y, tooltip: "是否為遠程包" })),
                (vu = em({ type: Y, tooltip: "是否是SSS版" })),
                (Cu = em({ type: mt, tooltip: "使用哪個遠程包版本" })),
                tm(
                    ((Tu = t(
                        (Ou = (function (t) {
                            function o() {
                                ...
                                return (
                                    (e = t.call.apply(t, [this].concat(r)) || this),
                                    i(e, "m_gameShortName", Tu, n(e)),
                                    i(e, "m_scenePrefabPath", Nu, n(e)),
                                    i(e, "m_gameImgPath", ku, n(e)),
                                    i(e, "m_gameId", Iu, n(e)),
                                    i(e, "m_logoName", Au, n(e)),
                                    i(e, "m_isLockLandScope", Ru, n(e)),
                                    i(e, "m_isLockPortrait", xu, n(e)),
                                    i(e, "m_isStreet", Lu, n(e)),
                                    i(e, "m_singleLogo", Pu, n(e)),
                                    i(e, "m_logoSpriteAtlas", Bu, n(e)),
                                    i(e, "m_pagePrefabPaths", Fu, n(e)),
                                    i(e, "m_infoNames", Mu, n(e)),
                                    i(e, "m_featureSpriteFrames", Du, n(e)),
                                    i(e, "m_bgSpriteFrames", zu, n(e)),
                                    i(e, "m_characterSpriteFrame", Gu, n(e)),
                                    i(e, "m_chilliNum", Hu, n(e)),
                                    i(e, "m_maxWinNum", Vu, n(e)),
                                    i(e, "m_autoplayPanelNo", Wu, n(e)),
                                    i(e, "m_isWatting", Uu, n(e)),
                                    i(e, "m_skipIntro", ju, n(e)),
                                    i(e, "m_styleSetting", Xu, n(e)),
                                    i(e, "m_playTypeSetting", Ju, n(e)),
                                    i(e, "m_isRemote", qu, n(e)),
                                    i(e, "m_isSSS", Yu, n(e)),
                                    i(e, "m_ReomveVersion", Ku, n(e)),
                            ...
                            return (
                                        ...
                                        S().mark(function t(e, i, n, o) {
                                            ...
                                            return S().wrap(function (t) {
                                                for (;;)
                                                    switch ((t.prev = t.next)) {
                                                        case 0:
                                                            if ((void 0 === n && (n = ""), void 0 === o && (o = ""), Zu)) {
                                                                t.next = 4;
                                                                break;
                                                            }
                                                            return t.abrupt("return");
                                                        case 4:
                                                            if (!(Zu.loadedZipNames.indexOf(e) >= 0)) {
                                                                t.next = 6;
                                                                break;
                                                            }
                                                            return t.abrupt("return");
                                                        ...
                                                        case 8:
                                                            return (
                                                                ...
                                                                (a = o),
                                                                i ||
                                                                    ((s = Tt.querySettings(Nt.Category.ASSETS, "bundleVers")),
                                                                    (r = "./assets/" + e),
                                                                    (a = s[e])),
                                                                Zu.loadedZipNames.push(e),
                                                                (t.next = 13),
                                                                Zu.loadZip(r, a)
                                                            );
                                                        case 13:
                                ...
                                (r.LoadVersion = (function () {
                                    var t = _(
                                        S().mark(function t(e) {
                                            var i, n, o, r, a, s, l, c, u, m, h, p, d, f, y, g, b, w, v, C, E, O, T, N;
                                            return S().wrap(
                                                function (t) {
                                                    for (;;)
                                                        switch ((t.prev = t.next)) {
                                                            ...
                                                            case 33:
                                                                if (
                                                                    ((C = t.sent),
                                                                    (E = "" + g + b + "/" + y + "/" + w + "/src/chunks/bundle." + C.json["bundle.js"] + ".js"),
                                                                    !vt.isNative)
                                                                ) {
                                                                    t.next = 40;
                                                                    break;
                                                            ...
                                                            case 63:
                                                                ((T = t.sent),
                                                                    (this.m_otherBundle = T[0]),
                                                                    (this.m_gameBundle = T[1]),
                                                                    (this.m_commonMainBundle = T[2]),
                                                                    (this.m_langTextBundle = T[3]),
                                                                    this.CheckBundles(),
                                                                    (t.next = 76));
                                                                break;
                                                            case 71:
                                                                return (
                                                                    (N = [
                                                                        ...
                                                                        this.LoadBundleSync(o, l, Qu.CommonMainBundle),
                                                                        this.LoadBundleSync(r, u, Qu.OtherBundle),
                                                                        this.LoadBundleSync(a, c, Qu.LangTextBundle),
                                                                        this.LoadZip(n + "Main", this.m_isRemote, o, l),
                                                                        this.LoadBundleSync(this.m_commonPath, this.m_commonVersion, Qu.CommonBundle),
                                                                    ]),
                                                                    this.m_isForceLite
                                                                        ? N.push(this.LoadBundleSync("assets/gameLite", "", Qu.GameBundle))
                                                                        : this.m_isTaDa || N.push(this.LoadBundleSync("assets/game", "", Qu.GameBundle)),
                                                                    (t.next = 75),
                                                                    Promise.all(N)
                                                                );
                                                            case 75:
                                    ...
                                    return new Promise(function (r) {
                                        o.LoadBundle(
                                            ...
                                            function (t) {
                                                if (void 0 !== i)
                                                    switch (i) {
                                                        case Qu.CommonMainBundle:
                                                            o.m_commonMainBundle = t;
                                                            break;
                                                        case Qu.CommonBundle:
                                                            o.m_commonBundle = t;
                                                            break;
                                                        case Qu.OtherBundle:
                                                            o.m_otherBundle = t;
                                                            break;
                                                        case Qu.LangTextBundle:
                                ...
                                (r.LoadIntroCell = function (t) {
                                    var e = this;
                                    this.m_gameBundle.load(this.m_pagePrefabPaths[t], Ot, function (i, n) {
                                ...
                                (r.GetLanguage = function () {
                                    ...
                                    if ((null != (t = window) && null != (e = t.location) && null != (i = e.href) && i.includes("/sss-") && (n = om.EN), n)) {
                                ...
                                (r.IsTada = function () {
                                    var t = (this.GetLinkParameterByName("gs") || "gnidnawcs").split("").reverse().join(""),
                                        ...
                                        i = -1 !== t.search("tada");
                                    if (!isNaN(e)) {
                                        ((this.m_apiId = Number(e)), (this.m_isForceLite = -1 !== $u.indexOf("gameLite") && sm.includes(this.m_apiId)));
                                    ...
                                    return (!r || (r != cm.TADA.toString() && r != cm.TADA_CASINO.toString()) || (i = !0), i);
                                }),
                                ...
                                (r.FormatLang = function (t) {
                                    return (t = t.toLocaleLowerCase()) == rm.CN || t == om.CN.toLocaleLowerCase()
                                        ? rm.CN
                                        : t == rm.EN || t == om.EN.toLocaleLowerCase()
                                          ? rm.EN
                                          : t == rm.TH || t == om.TH.toLocaleLowerCase()
                                            ? rm.TH
                                            : t == rm.VN || t == om.VN.toLocaleLowerCase()
                                              ? rm.VN
                                              : t == rm.ID || t == om.ID.toLocaleLowerCase()
                                                ? rm.ID
                                                : t == rm.HI || t == om.HI.toLocaleLowerCase()
                                                  ? rm.HI
                                                  : t == rm.TA || t == om.TA.toLocaleLowerCase()
                                                    ? rm.TA
                                                    : t == rm.MM || t == om.MM.toLocaleLowerCase()
                                                      ? rm.MM
                                                      : t == rm.JP || t == om.JP.toLocaleLowerCase()
                                                        ? rm.JP
                                                        : t == rm.MS || t == om.MS.toLocaleLowerCase()
                                                          ? rm.MS
                                                          : t == rm.KO || t == om.KO.toLocaleLowerCase()
                                                            ? rm.KO
                                                            : t == rm.BN || t == om.BN.toLocaleLowerCase()
                                                              ? rm.BN
                                                              : t == rm.ES || t == om.ES.toLocaleLowerCase()
                                                                ? rm.ES
                                                                : t == rm.PT || t == om.PT.toLocaleLowerCase()
                                                                  ? rm.PT
                                                                  : t == rm.IT || t == om.IT.toLocaleLowerCase()
                                                                    ? rm.IT
                                                                    : t == rm.SE || t == om.SE.toLocaleLowerCase()
                                                                      ? rm.SE
                                                                      : t == rm.DE || t == om.DE.toLocaleLowerCase()
                                                                        ? rm.DE
                                                                        : t == rm.DADK || t == om.DADK.toLocaleLowerCase()
                                                                          ? rm.DADK
                                                                          : t == rm.RORO || t == om.RORO.toLocaleLowerCase()
                                                                            ? rm.RORO
                                                                            : t == rm.NLNL || t == om.NLNL.toLocaleLowerCase()
                                                                              ? rm.NLNL
                                                                              : t == rm.TRTR.toLocaleLowerCase() || t == om.TRTR.toLocaleLowerCase()
                                                                                ? rm.TRTR
                                                                                : t == rm.RURU.toLocaleLowerCase() || t == om.RURU.toLocaleLowerCase()
                                                                                  ? rm.RURU
                                                                                  : t == rm.GRGR.toLocaleLowerCase() || t == om.GRGR.toLocaleLowerCase()
                                                                                    ? rm.GRGR
                                                                                    : t == rm.FRFR.toLocaleLowerCase() || t == om.FRFR.toLocaleLowerCase()
                                                                                      ? rm.FRFR
                                                                                      : "";
                                }),
                                o
                    ...
                    (Nu = t(Ou.prototype, "m_scenePrefabPath", [tu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (ku = t(Ou.prototype, "m_gameImgPath", [eu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Au = t(Ou.prototype, "m_logoName", [nu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Ru = t(Ou.prototype, "m_isLockLandScope", [ou], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (xu = t(Ou.prototype, "m_isLockPortrait", [ru], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Lu = t(Ou.prototype, "m_isStreet", [au], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Pu = t(Ou.prototype, "m_singleLogo", [su], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Bu = t(Ou.prototype, "m_logoSpriteAtlas", [lu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Fu = t(Ou.prototype, "m_pagePrefabPaths", [cu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Mu = t(Ou.prototype, "m_infoNames", [uu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Du = t(Ou.prototype, "m_featureSpriteFrames", [mu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (zu = t(Ou.prototype, "m_bgSpriteFrames", [hu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Gu = t(Ou.prototype, "m_characterSpriteFrame", [pu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Hu = t(Ou.prototype, "m_chilliNum", [_u], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Vu = t(Ou.prototype, "m_maxWinNum", [du], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Wu = t(Ou.prototype, "m_autoplayPanelNo", [fu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Uu = t(Ou.prototype, "m_isWatting", [yu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (ju = t(Ou.prototype, "m_skipIntro", [gu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Xu = t(Ou.prototype, "m_styleSetting", [Su], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Ju = t(Ou.prototype, "m_playTypeSetting", [bu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (qu = t(Ou.prototype, "m_isRemote", [wu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (Ku = t(Ou.prototype, "m_ReomveVersion", [Cu], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
            ...
            var Em = E.ccclass,
                Om = E.property,
                Tm = function (t, e, i, n, o, r) {
                    ((this.name = t), (this.height = e), (this.width = i), (this.ratio = n), (this.statusHeight = o), (this.homeHeight = r));
                },
                Nm = [
                    new Tm("iPhone 6.5-inch", 896, 414, 3, 44, 34),
                    new Tm("iPhone 6.1-inch", 896, 414, 2, 44, 34),
                    new Tm("iPhone 5.8-inch", 812, 375, 3, 44, 34),
                    new Tm("iPhone 5.5-inch", 736, 414, 3, 18, 0),
                    new Tm("iPhone 4.7-inch", 667, 375, 2, 20, 0),
                    new Tm("iPhone 4-inch", 568, 320, 2, 20, 0),
                    new Tm("iPhone 3.5-inch", 480, 320, 2, 20, 0),
                    new Tm("iPhone(Legacy) & iPod Touch", 480, 320, 1, 20, 0),
                    new Tm("iPad Pro 12.9-inch", 1366, 1024, 2, 20, 0),
                    new Tm("iPad Pro 10.5-inch", 1112, 834, 2, 20, 0),
                    new Tm("iPad 9.7-inch Retina", 1024, 768, 2, 20, 0),
                    new Tm("iPad", 1024, 768, 1, 20, 0),
                    new Tm("iPad Mini Retina", 1024, 768, 2, 20, 0),
                    new Tm("iPad Mini", 1024, 768, 1, 20, 0),
                ],
                km = "mask",
                Im = "mask_close_tip",
                Am = "mask_close",
            ...
            ((um = Om(Boolean)),
                ...
                Em(
                    ((ym = t(
                        (fm = (function (t) {
                            function o() {
                                ...
                                return (
                                    (e = t.call.apply(t, [this].concat(r)) || this),
                                    i(e, "isLandscape", ym, n(e)),
                                    i(e, "isPortrait", gm, n(e)),
                                    i(e, "isIOS", Sm, n(e)),
                                    i(e, "isAndroid", bm, n(e)),
                                    i(e, "android_Apiid", wm, n(e)),
                                    (e.m_mask = null),
                                    (e.m_isScrolling = !1),
                                    (e.m_isblock = !1),
                            ...
                            return (
                                (r.onLoad = function () {
                                    vt.isNative || this.Init();
                                }),
                                (r.GetDeviceName = function () {
                                    if (vt.os === vt.OS.IOS) {
                                        var t = this.GetiOSDevice();
                                        if (t) return t.name;
                                    } else if (vt.os === vt.OS.ANDROID) {
                                ...
                                (r.CreateHtmlTag = function () {
                                    if (!this.m_backGround) {
                                        ...
                                        ((i.id = Rm), (i.style.position = "absolute"), (i.style.height = "100vh"));
                                ...
                                (r.Init = function () {
                                    ...
                                    if (
                                        (this.isPortrait
                                            ? (this.m_isblock = Wm.indexOf(i) >= 0)
                                            : this.isAndroid && this.android_Apiid.length > 0 && this.android_Apiid.indexOf(i) >= 0 && (this.isAndroid = !1),
                                        this.m_isblock || (this.m_isblock = Um.indexOf(i) >= 0),
                                        !e && !this.m_isblock)
                                    )
                                        if ((this.AddGameViewMask(), (this.isIOS = !1), vt.os == vt.OS.IOS && 0 == this.IsWebview() && this.isIOS))
                                            if (
                                                (this.CreateHtmlTag(),
                                                ...
                                                document.body.onresize = function () {
                                                    ...
                                                    var e = document.documentElement.scrollWidth,
                                                        ...
                                                        n = e > i;
                                                    (document.getElementById(Rm).clientHeight == window.innerHeight ? t.HideMask() : t.SetShowMask(n),
                                                        window.addEventListener(
                                                            "scroll",
                                                            function () {
                                                                return (t.m_isScrolling = !0);
                                        ...
                                        else if (vt.os == vt.OS.ANDROID && 0 == this.IsWebview() && this.isAndroid)
                                            if (vt.browserType == vt.BrowserType.MOBILE_QQ || vt.browserType == vt.BrowserType.UC);
                                            else {
                                                var s = function () {
                                ...
                                (r.SetShowMask = function (t) {
                                    if ((void 0 === t && (t = void 0), this.IsIOS15orOver()))
                                        if (void 0 === t) {
                                            ...
                                            (document.getElementById(Rm).clientHeight,
                                                window.innerHeight,
                                                (t === this.m_isLandscape && document.getElementById(Rm).clientHeight === window.innerHeight) ||
                                                    (t
                                                        ? this.IsIOS15Version(0) || this.IsIOS15Version(1) || this.IsIOS15Version(2) || this.IsIOS15Version(3)
                                                            ? (this.m_backGround.style.visibility = "hidden")
                                                            : (this.m_backGround.style.visibility = "visible")
                                ...
                                (r.SetCloseContent = function () {
                                    var t = this,
                                        e = this.GetLang("lang");
                                    e = this.ChangeLang(e);
                                    var i = document.getElementById(Am),
                                        n = this.isLandscape ? document.getElementById(Im) : null;
                                    (xm[e]
                                        ? ((i.textContent = xm[e][0]), n && (n.textContent = xm[e][1]))
                                        : ((i.textContent = xm[Bm[0]][0]), n && (n.textContent = xm[Bm[0]][1])),
                                        i.onclick ||
                                            (i.onclick = function () {
                                                t.HideMask();
                                            }));
                                ...
                                (r.GetLang = function (t) {
                                    var e = vt.localStorage.getItem("LobbyLanguage");
                                    if (!e || "" == e) {
                                ...
                                (r.AddGameViewMask = function () {
                                    var t = this,
                                        e = pt.getScene();
                                    this.m_mask || e.getChildByName("ScrollForMask") || vt.browserType == vt.BrowserType.FIREFOX
                                        ? !this.m_mask && e.getChildByName("ScrollForMask") && (this.m_mask = It("ScrollForMask"))
                                        : ((this.m_mask = new k()),
                                          (this.m_mask.name = "ScrollForMask"),
                                          this.m_mask.addComponent(N).setContentSize(new At(2e3, 2e3)),
                                          this.m_mask.addComponent(ut),
                                          (this.m_mask.active = !1),
                                          e.addChild(this.m_mask),
                                          this.m_mask.setSiblingIndex(e.children.length),
                                          this.m_mask.on(k.EventType.TOUCH_END, function () {
                                              if (vt.os == vt.OS.IOS && 0 == t.IsWebview()) {
                                                  var e = t.m_backGround;
                                                  e && "hidden" == e.style.visibility && (t.m_mask.active = !1);
                                              } else vt.os == vt.OS.ANDROID && 0 == t.IsWebview() && t.Fullscreen();
                                          }));
                                }),
                                ...
                                (r.IsIOS15orOver = function () {
                                    return vt.os == vt.OS.IOS && /iPhone OS 15/.test(window.navigator.userAgent);
                                }),
                                (r.IsIOS15Version = function (t) {
                                    return vt.os == vt.OS.IOS && -1 !== window.navigator.userAgent.search("iPhone OS 15_" + t);
                                }),
                                o
                            );
                        })(G)).prototype,
                    ...
                    (gm = t(fm.prototype, "isPortrait", [mm], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (bm = t(fm.prototype, "isAndroid", [pm], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
                    ...
                    (wm = t(fm.prototype, "android_Apiid", [_m], {
                        configurable: !0,
                        enumerable: !0,
                        writable: !0,
                        initializer: function () {
